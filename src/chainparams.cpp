...
{
    const char* pszTimestamp = "I am learning coin development";
     ...
     //   consensus.BIP34Height = 710000;
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1517356801; // January 31st, 2018
       ...
       // consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1698896958, 2001739445, 0x1e0ffff0, 1, 100 * COIN);
       ...
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x4acacbd47a670d2533233c53135b87aee51319c4acb15c9efc3ec6762ae24d6d"))
        ...
        chainTxData = ChainTxData{
            ...
            1698896958, // * UNIX timestamp of last known number of transactions
    ...
    CTestNetParams() {
      ...
      //  consensus.BIP34Height = 76;
       ...
       // consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1698896958, 1253786, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa831046a7fc30844ee8e48a8abe36dcaa62f6b2bf3c4490776cbdaa1da7796ad"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d4dc62f739342f41816db24439625a882b3d2a15b8857037b4e7fc34e8c3355"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xa831046a7fc30844ee8e48a8abe36dcaa62f6b2bf3c4490776cbdaa1da7796ad")),
        };
...
public:
    CRegTestParams() {
       ...
       // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x34332016a37e0ca2687af7ff7e10d48e853a5fca070599de67128b345ed8122d"))
        };
