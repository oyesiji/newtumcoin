...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s newtumcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  newtumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded newtumcoin transaction") + "\n" +
              "  newtumcoin-tx [options] -create [commands]   " + _("Create hex-encoded newtumcoin transaction") + "\n" +
              "\n";
