...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/newtumcoin-project/newtumcoin>";
    const std::string URL_WEBSITE = "<https://newtumcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Newtumcoin version %s\n", FormatFullVersion());
}
